...
export function UseONGs(){
    return [
        ...
        },
        {
            ...
            "description":"TIMISOARA, CABINETUL DE NEUROLOGIE DIN SPITALUL JUDETEAN TIMISOARA	-este lupta impotriva sclerozei multiple si a bolilor asociate, ajutorarea bolnavilor, sprijinul cercetarilor stiintifice si aspecialistilor din domeniu."
        },
        {
